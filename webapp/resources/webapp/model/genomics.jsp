  ...
  <tr>
        ...
        <ul>
          <li>
            <a href="http://www.genedb.org/">
              Fasta sequences for <i>Medicago truncatula</i></a>
          </li>
          <li>
            <a href="http://www.genedb.org/">
              GFF3 for <i>Medicago truncatula</i> genome features</a>
          </li>
        </ul>
      </div>
    </td>
    <td width="40%" valign="top">
      <div class="body">
        <ul>
          <li>
            <im:querylink text="All <i>Medicago truncatula</i> genes identifiers, chromosome positions and chromosome identifiers" skipBuilder="true">
