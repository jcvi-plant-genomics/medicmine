...
<table width="100%">
  <tr>
    ...
    <td valign="top">
      <div class="heading2">
        Bulk download <i>Medicago truncatula</i> data
      </div>
      <div class="body">
        <ul>
          <li>
            <span style="white-space:nowrap">
              <im:querylink text="Medicago truncatula proteins and corresponding genes:" skipBuilder="true">
<query name="" model="genomic" view="Protein.primaryIdentifier Protein.primaryAccession Protein.organism.name Protein.genes.primaryIdentifier Protein.genes.secondaryIdentifier Protein.genes.organism.shortName" sortOrder="Protein.primaryIdentifier asc">
  <constraint path="Protein.organism.name" op="=" value="Medicago truncatula"/>
</query>
              </im:querylink>
            </span>
          </li>
